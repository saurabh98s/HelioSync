"""
Database models for the Federated Learning web interface.
"""
...
# Association table for many-to-many relationship between organizations and projects
...
class Organization(db.Model):
    ...
    creator_id = db.Column(db.Integer, db.ForeignKey('users.id', use_alter=True, name='fk_org_creator'), nullable=True)
